...
`,
  ...
  {
    name: "Long sequence of alternating bits.",
    bitmaps: [
      new Array(100_000).fill(1), // --------------> 01010101010101010101..1
      new Array(100_000).fill(0).fill(1, 1), // ---> 10101010101010101010..0
    ],
    expectedOR: [0, 100_000],
    expectedAND: [],
    expectedXOR: [0, 100_000],
    detail: `
01010101010101010101..1
10101010101010101010..0
-----------------------
11111111111111111111..1 [0, 100_000] <- OR
00000000000000000000..0 [] <----------- AND
11111111111111111111..1 [0, 100_000] <- XOR
`,
  },
  {
    name: "1 million sequence of alternating bits.",
    bitmaps: [
      new Array(1_000_000).fill(1), // --------------> 01010101010101010101..1
      new Array(1_000_000).fill(0).fill(1, 1), // ---> 10101010101010101010..0
    ],
    expectedOR: [0, 1_000_000],
    expectedAND: [],
    expectedXOR: [0, 1_000_000],
    detail: `
01010101010101010101..1
10101010101010101010..0
-----------------------
